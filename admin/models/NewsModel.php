<?php 
	trait NewsModel{
		...
		public function modelUpdate(){
			...
			$db = Connection::getInstance();
			//chuan bi truy van
			$query = $db->prepare("update news set name = :var_name, mota = :var_mota, noidung = :var_noidung,hot = :var_hot where id=:var_id");
			//thuc thi truy van, co truyen tham so vao cau lenh sql
			$query->execute(["var_id"=>$id,"var_name"=>$name,"var_mota"=>$mota,"var_noidung"=>$noidung,"var_hot"=>$hot]);	
			//---
		...
		public function modelCreate(){
			...
			//---			
			//chuan bi truy van
			$query = $db->prepare("insert into news set name = :var_name, mota = :var_mota, noidung = :var_noidung,hot = :var_hot,photo = :var_photo");
			//thuc thi truy van, co truyen tham so vao cau lenh sql
			$query->execute(["var_name"=>$name,"var_mota"=>$mota,"var_noidung"=>$noidung,"var_hot"=>$hot,"var_photo"=>$photo]);	
